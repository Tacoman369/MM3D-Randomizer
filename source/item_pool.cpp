...
static void PlaceVanillaChestItems() {
	PlaceItemInLocation(DEKU_PALACE_BEAN_GROTTO_CHEST, RED_RUPEE, true);
	...
	PlaceItemInLocation(GBC_GROTTO_CHEST, RED_RUPEE, true);
	PlaceItemInLocation(IKANA_CANYON_SECRET_SHRINE_GROTTO_CHEST, BOMBCHU_5, true);
	...
	PlaceItemInLocation(IKANA_GRAVEYARD_GROTTO_CHEST, BOMBCHU_5, true);
	PlaceItemInLocation(MOUNTAIN_WATERFALL_CHEST, RED_RUPEE, true);
	PlaceItemInLocation(MOUNTAIN_VILLAGE_SPRING_WATER_GROTTO_CHEST, RED_RUPEE, true);
	PlaceItemInLocation(ROAD_TO_SNOWHEAD_GROTTO_CHEST, RED_RUPEE, true);
	...
	PlaceItemInLocation(ROAD_TO_IKANA_GROTTO_CHEST, RED_RUPEE, true);
	PlaceItemInLocation(ROAD_TO_SWAMP_GROTTO_CHEST, RED_RUPEE, true);
	...
	PlaceItemInLocation(SOUTHERN_SWAMP_NEAR_SPIDER_HOUSE_GROTTO_CHEST, RED_RUPEE, true);
	PlaceItemInLocation(SOUTHERN_SWAMP_MYSTERY_WOODS_GROTTO_CHEST, PURPLE_RUPEE, true);
	...
	PlaceItemInLocation(TERMINA_FIELD_PEAHAT_GROTTO_CHEST, PIECE_OF_HEART, true);
	PlaceItemInLocation(TERMINA_FIELD_DODONGO_GROTTO_CHEST, PIECE_OF_HEART, true);
	PlaceItemInLocation(TERMINA_FIELD_PILLAR_GROTTO_CHEST, BOMBCHU_5, true);
	PlaceItemInLocation(TERMINA_FIELD_GRASS_GROTTO_CHEST, RED_RUPEE, true);
	...
	PlaceItemInLocation(HOT_SPRING_WATER_GROTTO_CHEST, RED_RUPEE, true);
	PlaceItemInLocation(TWIN_ISLANDS_GORON_RACETRACK_GROTTO_CHEST, BOMBCHU_5, true);
	...
	PlaceItemInLocation(ZORA_CAPE_GROTTO_CHEST, BOMBCHU_5, true);
...
static void PlaceVanillaLogicHelpers() {
	...
	PlaceItemInLocation(HMS_DEKU_MASK, DEKU_MASK, true);
	PlaceItemInLocation(HMS_STARTING_SWORD, KOKIRI_SWORD, true);
